...
public class DatePickerDialog extends DialogFragment implements
    ...
    private int mMontOfYearEnd;
    private int mDayOfMonthEnd;
     ...
     * @param isSingleTab 是否只要一个tab
     * @return
     */
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                               int monthOfYear,
                                               int dayOfMonth, boolean isSingleTab) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, isSingleTab);
        return ret;
    }
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                               ...
                                               int dayOfMonth) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, false);
        return ret;
    }
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                               ...
                                               int dayOfMonthEnd) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, yearEnd, montOfYearEnd, dayOfMonthEnd, false);
        return ret;
    }

    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, boolean isSingleTab) {
        initialize(callBack, year, monthOfYear, dayOfMonth, year, monthOfYear, dayOfMonth, isSingleTab);
    }
    ...
    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, int yearEnd,
        ...
        mYearEnd = yearEnd;
        mMontOfYearEnd = montOfYearEnd;
        mDayOfMonthEnd = dayOfMonthEnd;
        mIsSingleTab = isSingleTab;
